...
namespace battlefieldoop.GameGL
{
    class Henemy2 : enemy
    {
        ...
        public Henemy2(Form form, int lives, GameBattlePlayer player, GameDirection direction, Image image, GameCell startCell) : base(form, lives, GameObjectType.ENEMY, image, direction)
        {
        ...
        public override void flipPlayer()
        {
            ...
            {
                this.CurrentCell.PictureBox.Image = battlefieldoop.Properties.Resources.enemy2oppo;
            }
            if (flipPosition == "Right")
            {
                this.CurrentCell.PictureBox.Image = battlefieldoop.Properties.Resources.enemy2;
            }
        }
